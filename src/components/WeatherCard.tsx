import { WeatherCardProps } from "../types/WeatherAPIResponse";
      ...
      <>
         <div className="flex flex-col gap-4 items-center justify-center">
            ...
            <h3 className="relative right-2 text-5xl text-white font-bold">
               {temperature == "not found"? ' ': Number(temperature).toFixed(0)} <span className="absolute top-0 left-14 text-xl font-normal">{temperature == "not found"? " " : '°C'}</span>
            </h3>
